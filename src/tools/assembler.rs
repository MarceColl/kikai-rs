...
fn parse_instruction(chunk: &String) -> Option<Instr> {
   match chunk.as_str() {
       "BRK" => Some(Instr::BRK), "INC" => Some(Instr::INC), "POP" => Some(Instr::POP), "NIP" => Some(Instr::NIP),
       "SWP" => Some(Instr::SWP), "ROT" => Some(Instr::ROT), "DUP" => Some(Instr::DUP), "OVR" => Some(Instr::OVR),
       "EQU" => Some(Instr::EQU), "NEQ" => Some(Instr::NEQ), "GTH" => Some(Instr::GTH), "LTH" => Some(Instr::LTH),
       "JMP" => Some(Instr::JMP), "JCN" => Some(Instr::JCN), "JSR" => Some(Instr::JSR), "STH" => Some(Instr::STH),
       "LDZ" => Some(Instr::LDZ), "STZ" => Some(Instr::STZ), "LDR" => Some(Instr::LDR), "STR" => Some(Instr::STR),
       "LDA" => Some(Instr::LDA), "STA" => Some(Instr::STA), "DEI" => Some(Instr::DEI), "DEO" => Some(Instr::DEO),
       "ADD" => Some(Instr::ADD), "SUB" => Some(Instr::SUB), "MUL" => Some(Instr::MUL), "DIV" => Some(Instr::DIV),
       "AND" => Some(Instr::AND), "ORA" => Some(Instr::ORA), "EOR" => Some(Instr::EOR), "SFT" => Some(Instr::SFT),
       "JCI" => Some(Instr::JCI), "INC2" => Some(Instr::INC2), "POP2" => Some(Instr::POP2), "NIP2" => Some(Instr::NIP2),
       "SWP2" => Some(Instr::SWP2), "ROT2" => Some(Instr::ROT2), "DUP2" => Some(Instr::DUP2), "OVR2" => Some(Instr::OVR2),
       "EQU2" => Some(Instr::EQU2), "NEQ2" => Some(Instr::NEQ2), "GTH2" => Some(Instr::GTH2), "LTH2" => Some(Instr::LTH2),
       "JMP2" => Some(Instr::JMP2), "JCN2" => Some(Instr::JCN2), "JSR2" => Some(Instr::JSR2), "STH2" => Some(Instr::STH2),
       "LDZ2" => Some(Instr::LDZ2), "STZ2" => Some(Instr::STZ2), "LDR2" => Some(Instr::LDR2), "STR2" => Some(Instr::STR2),
       "LDA2" => Some(Instr::LDA2), "STA2" => Some(Instr::STA2), "DEI2" => Some(Instr::DEI2), "DEO2" => Some(Instr::DEO2),
       "ADD2" => Some(Instr::ADD2), "SUB2" => Some(Instr::SUB2), "MUL2" => Some(Instr::MUL2), "DIV2" => Some(Instr::DIV2),
       "AND2" => Some(Instr::AND2), "ORA2" => Some(Instr::ORA2), "EOR2" => Some(Instr::EOR2), "SFT2" => Some(Instr::SFT2),
       "JMI" => Some(Instr::JMI), "INCr" => Some(Instr::INCr), "POPr" => Some(Instr::POPr), "NIPr" => Some(Instr::NIPr),
       "SWPr" => Some(Instr::SWPr), "ROTr" => Some(Instr::ROTr), "DUPr" => Some(Instr::DUPr), "OVRr" => Some(Instr::OVRr),
       "EQUr" => Some(Instr::EQUr), "NEQr" => Some(Instr::NEQr), "GTHr" => Some(Instr::GTHr), "LTHr" => Some(Instr::LTHr),
       "JMPr" => Some(Instr::JMPr), "JCNr" => Some(Instr::JCNr), "JSRr" => Some(Instr::JSRr), "STHr" => Some(Instr::STHr),
       "LDZr" => Some(Instr::LDZr), "STZr" => Some(Instr::STZr), "LDRr" => Some(Instr::LDRr), "STRr" => Some(Instr::STRr),
       "LDAr" => Some(Instr::LDAr), "STAr" => Some(Instr::STAr), "DEIr" => Some(Instr::DEIr), "DEOr" => Some(Instr::DEOr),
       "ADDr" => Some(Instr::ADDr), "SUBr" => Some(Instr::SUBr), "MULr" => Some(Instr::MULr), "DIVr" => Some(Instr::DIVr),
       "ANDr" => Some(Instr::ANDr), "ORAr" => Some(Instr::ORAr), "EORr" => Some(Instr::EORr), "SFTr" => Some(Instr::SFTr),
       "JSI" => Some(Instr::JSI), "INC2r" => Some(Instr::INC2r), "POP2r" => Some(Instr::POP2r), "NIP2r" => Some(Instr::NIP2r),
       "SWP2r" => Some(Instr::SWP2r), "ROT2r" => Some(Instr::ROT2r), "DUP2r" => Some(Instr::DUP2r), "OVR2r" => Some(Instr::OVR2r),
       "EQU2r" => Some(Instr::EQU2r), "NEQ2r" => Some(Instr::NEQ2r), "GTH2r" => Some(Instr::GTH2r), "LTH2r" => Some(Instr::LTH2r),
       "JMP2r" => Some(Instr::JMP2r), "JCN2r" => Some(Instr::JCN2r), "JSR2r" => Some(Instr::JSR2r), "STH2r" => Some(Instr::STH2r),
       "LDZ2r" => Some(Instr::LDZ2r), "STZ2r" => Some(Instr::STZ2r), "LDR2r" => Some(Instr::LDR2r), "STR2r" => Some(Instr::STR2r),
       "LDA2r" => Some(Instr::LDA2r), "STA2r" => Some(Instr::STA2r), "DEI2r" => Some(Instr::DEI2r), "DEO2r" => Some(Instr::DEO2r),
       "ADD2r" => Some(Instr::ADD2r), "SUB2r" => Some(Instr::SUB2r), "MUL2r" => Some(Instr::MUL2r), "DIV2r" => Some(Instr::DIV2r),
       "AND2r" => Some(Instr::AND2r), "ORA2r" => Some(Instr::ORA2r), "EOR2r" => Some(Instr::EOR2r), "SFT2r" => Some(Instr::SFT2r),
       "LIT" => Some(Instr::LIT), "INCk" => Some(Instr::INCk), "POPk" => Some(Instr::POPk), "NIPk" => Some(Instr::NIPk),
       "SWPk" => Some(Instr::SWPk), "ROTk" => Some(Instr::ROTk), "DUPk" => Some(Instr::DUPk), "OVRk" => Some(Instr::OVRk),
       "EQUk" => Some(Instr::EQUk), "NEQk" => Some(Instr::NEQk), "GTHk" => Some(Instr::GTHk), "LTHk" => Some(Instr::LTHk),
       "JMPk" => Some(Instr::JMPk), "JCNk" => Some(Instr::JCNk), "JSRk" => Some(Instr::JSRk), "STHk" => Some(Instr::STHk),
       "LDZk" => Some(Instr::LDZk), "STZk" => Some(Instr::STZk), "LDRk" => Some(Instr::LDRk), "STRk" => Some(Instr::STRk),
       "LDAk" => Some(Instr::LDAk), "STAk" => Some(Instr::STAk), "DEIk" => Some(Instr::DEIk), "DEOk" => Some(Instr::DEOk),
       "ADDk" => Some(Instr::ADDk), "SUBk" => Some(Instr::SUBk), "MULk" => Some(Instr::MULk), "DIVk" => Some(Instr::DIVk),
       "ANDk" => Some(Instr::ANDk), "ORAk" => Some(Instr::ORAk), "EORk" => Some(Instr::EORk), "SFTk" => Some(Instr::SFTk),
       "LIT2" => Some(Instr::LIT2), "INC2k" => Some(Instr::INC2k), "POP2k" => Some(Instr::POP2k), "NIP2k" => Some(Instr::NIP2k),
       "SWP2k" => Some(Instr::SWP2k), "ROT2k" => Some(Instr::ROT2k), "DUP2k" => Some(Instr::DUP2k), "OVR2k" => Some(Instr::OVR2k),
       "EQU2k" => Some(Instr::EQU2k), "NEQ2k" => Some(Instr::NEQ2k), "GTH2k" => Some(Instr::GTH2k), "LTH2k" => Some(Instr::LTH2k),
       "JMP2k" => Some(Instr::JMP2k), "JCN2k" => Some(Instr::JCN2k), "JSR2k" => Some(Instr::JSR2k), "STH2k" => Some(Instr::STH2k),
       "LDZ2k" => Some(Instr::LDZ2k), "STZ2k" => Some(Instr::STZ2k), "LDR2k" => Some(Instr::LDR2k), "STR2k" => Some(Instr::STR2k),
       "LDA2k" => Some(Instr::LDA2k), "STA2k" => Some(Instr::STA2k), "DEI2k" => Some(Instr::DEI2k), "DEO2k" => Some(Instr::DEO2k),
       "ADD2k" => Some(Instr::ADD2k), "SUB2k" => Some(Instr::SUB2k), "MUL2k" => Some(Instr::MUL2k), "DIV2k" => Some(Instr::DIV2k),
       "AND2k" => Some(Instr::AND2k), "ORA2k" => Some(Instr::ORA2k), "EOR2k" => Some(Instr::EOR2k), "SFT2k" => Some(Instr::SFT2k),
       "LITr" => Some(Instr::LITr), "INCkr" => Some(Instr::INCkr), "POPkr" => Some(Instr::POPkr), "NIPkr" => Some(Instr::NIPkr),
       "SWPkr" => Some(Instr::SWPkr), "ROTkr" => Some(Instr::ROTkr), "DUPkr" => Some(Instr::DUPkr), "OVRkr" => Some(Instr::OVRkr),
       "EQUkr" => Some(Instr::EQUkr), "NEQkr" => Some(Instr::NEQkr), "GTHkr" => Some(Instr::GTHkr), "LTHkr" => Some(Instr::LTHkr),
       "JMPkr" => Some(Instr::JMPkr), "JCNkr" => Some(Instr::JCNkr), "JSRkr" => Some(Instr::JSRkr), "STHkr" => Some(Instr::STHkr),
       "LDZkr" => Some(Instr::LDZkr), "STZkr" => Some(Instr::STZkr), "LDRkr" => Some(Instr::LDRkr), "STRkr" => Some(Instr::STRkr),
       "LDAkr" => Some(Instr::LDAkr), "STAkr" => Some(Instr::STAkr), "DEIkr" => Some(Instr::DEIkr), "DEOkr" => Some(Instr::DEOkr),
       "ADDkr" => Some(Instr::ADDkr), "SUBkr" => Some(Instr::SUBkr), "MULkr" => Some(Instr::MULkr), "DIVkr" => Some(Instr::DIVkr),
       "ANDkr" => Some(Instr::ANDkr), "ORAkr" => Some(Instr::ORAkr), "EORkr" => Some(Instr::EORkr), "SFTkr" => Some(Instr::SFTkr),
       "LIT2r" => Some(Instr::LIT2r), "INC2kr" => Some(Instr::INC2kr), "POP2kr" => Some(Instr::POP2kr), "NIP2kr" => Some(Instr::NIP2kr),
       "SWP2kr" => Some(Instr::SWP2kr), "ROT2kr" => Some(Instr::ROT2kr), "DUP2kr" => Some(Instr::DUP2kr), "OVR2kr" => Some(Instr::OVR2kr),
       "EQU2kr" => Some(Instr::EQU2kr), "NEQ2kr" => Some(Instr::NEQ2kr), "GTH2kr" => Some(Instr::GTH2kr), "LTH2kr" => Some(Instr::LTH2kr),
       "JMP2kr" => Some(Instr::JMP2kr), "JCN2kr" => Some(Instr::JCN2kr), "JSR2kr" => Some(Instr::JSR2kr), "STH2kr" => Some(Instr::STH2kr),
       "LDZ2kr" => Some(Instr::LDZ2kr), "STZ2kr" => Some(Instr::STZ2kr), "LDR2kr" => Some(Instr::LDR2kr), "STR2kr" => Some(Instr::STR2kr),
       "LDA2kr" => Some(Instr::LDA2kr), "STA2kr" => Some(Instr::STA2kr), "DEI2kr" => Some(Instr::DEI2kr), "DEO2kr" => Some(Instr::DEO2kr),
       "ADD2kr" => Some(Instr::ADD2kr), "SUB2kr" => Some(Instr::SUB2kr), "MUL2kr" => Some(Instr::MUL2kr), "DIV2kr" => Some(Instr::DIV2kr),
       "AND2kr" => Some(Instr::AND2kr), "ORA2kr" => Some(Instr::ORA2kr), "EOR2kr" => Some(Instr::EOR2kr), "SFT2kr" => Some(Instr::SFT2kr),
       _ => None,
   }
}
...
impl Lexer {
    ...
    pub fn next_span(&mut self) -> Option<Span> {
        if self.cursor >= self.string.len() {
            ...
            while self.string.chars().nth(self.cursor).unwrap().is_whitespace() {
                self.cursor += 1;
            }
...
pub fn assemble(src: String) -> Result<Program, String> {
    ...
    for span in spans {
        ...
        match &span.atom {
            Atom::LParen => { in_comment = true; },
            Atom::RParen => { in_comment = false; }
...
".to_string();
        let program = assemble(src).unwrap();
        let expected = vec![
                0xa0, 0x01, 0x12, 0x60, 0x00, 0x01, 0x00, 0x94, 0x80, 0x18, 0x17, 0x21, 0x94, 0x20, 0xff, 0xf7,
                0x22, 0x6c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x21, 0x00
            ];
